...
<div class="pb-12">
    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                @auth
                    ...
                    @else
                        <button
                            ...
                            class="inline-flex items-center rounded-md px-4 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-50
        ...
        <div class="mt-6 flex items-center gap-4 text-sm">
            <a href="{{ route('profile.followers', $profileUser) }}" class="font-semibold text-gray-900 hover:underline">
                {{ $followersCount }} Followers
            </a>
            <a href="{{ route('profile.following', $profileUser) }}" class="font-semibold text-gray-900 hover:underline">
